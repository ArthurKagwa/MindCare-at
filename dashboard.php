...
// If the form is submitted to update DISTRICT or Email
        ...
        <nav class="navbar">
            <div class="navbar-container">
                <div class="navbar-logo">
                    <img src="IMAGES/ment.png" alt="Logo">
                </div>
                ...
                <div class="navbar-profile">
                    ...
                    <div class="profile-info">
                        ...
                        <p class="email">Welcome to MindCare platform, Your journey to inner peace starts here!</p>
                    </div>
                </div>
...
<script>
    ...
    <div class="container">
        <div class="left-sidebar">
            <div class="imp-links">
                <a href="#"><img src="IMAGES/news1.png">Mental Health Resources</a>
                <a href="#"><img src="IMAGES/buy_sell.png">Order Prescribed Medication</a>
                <a href="#"><img src="IMAGES/resources.png">Mindfulness and Relaxation Tools</a>
                <a href="#"><img src="IMAGES/FAQ.png">FAQs</a>
            </div>       
            <p>Check it on calender</p>
            <div class="cal">
            <div id='calendar'></div>
            </div>
        </div>
        ...
        <div class="main-content">
            <div class="slider">
                <p class="slider_heading">MENTAL HEALTH <br /> HUB</p>
                <p class="slider_par1"></p>
                <p class="slider_par2">Together for Your Mental Well-being.</p>
            </div>
            ...
            <div class="post-conatiner">
                ...
                <p class="post-text">
                         Stay committed to your mental well-being and explore the latest resources and strategies t
                         o support your journey. Connect with others who share your experiences and seek guidance 
                         from professionals to enhance your mental health. <br /><br />
                         Don't forget to check out the helpful resources and updates shared by Admin. 
                         They provide valuable insights and tips to help you thrive in your mental health journey!
                </p>
                <a href="#">#mentalhealthsupport</a>
                <a href="#">#WellnessJourney</a>
                <br >
                <?php if (!empty($posts)): ?>
    ...
    <div class="footer">
        ...
        <div class="footer-column">
            ...
            <ul>
                ...
                <li><a href="#">Marketplace Terms of Service</a></li>
            </ul>
        </div>
        <br>
        <div class="footer-column">
