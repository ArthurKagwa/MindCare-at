...
function authenticateUser($phone, $password, $conn) {
    ...
    $sql = "SELECT * FROM Details WHERE PHONE_NUMBER='$formattedPhone' AND PASSWORD='$password'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['signup'])) {
    ...
    $checkSql = "SELECT * FROM Details WHERE PHONE_NUMBER='$formattedPhone'";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $insertSql = "INSERT INTO Details (NAME, ROLE, PHONE_NUMBER, PASSWORD, profile_photo) VALUES ('$name', '$role', '$formattedPhone', '$password', '$profilePhotoPath')";
        if (mysqli_query($conn, $insertSql)) {
            $_SESSION['phone'] = $formattedPhone;
